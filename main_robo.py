...
MAPA_ESTADOS_BOTS = {
    "SANTA CATARINA": lambda ld, **kwargs: BotTRF4().executar(ld, estado="SC", **kwargs),
    "RIO GRANDE DO SUL": lambda ld, **kwargs: BotTRF4().executar(ld, estado="RS", **kwargs),
    "PARANA": lambda ld, **kwargs: BotTRF4().executar(ld, estado="PR", **kwargs)
}
